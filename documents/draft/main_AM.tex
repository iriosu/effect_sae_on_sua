...
\marar{SAE's staggered rollout reached all of a school's grades only after several years, so classes formed one to three years before the treatment date completed secondary school in classrooms partly filled by SAE-admitted students. A class formed one year before the treatment date, for example, was in tenth grade when SAE arrived, and SAE could place newly admitted students in its grade-11 and grade-12 classrooms. We set these transition classes aside, so that each group-time comparison is between fully-treated classes and classes that graduated before any SAE-admitted student entered the school; Appendix~\ref{app: measurement} gives the details.}
...
We observe that the average impact of the policy is positive and significant for several outcomes. Students who graduated from a treated school after the implementation of the policy were \marar{10.19\%} more likely to apply to the centralized college admissions system relative to their average in the pre-treatment period. Similarly, treated students were \marar{16.77\%} more likely to be assigned and \marar{17.74\%} more likely to enroll in a program that is part of the centralized college admissions system. Furthermore, we observe no significant effect on average high-school GPA.

\subsection{Heterogeneity}

\subsubsection{Gender.} Table~\ref{tab: did results by gender} reports the estimated aggregated treatment effects for each outcome of interest, separately by gender. Consistent with Table~\ref{tab: main results}, we find no effect on high‑school GPA. By contrast, we find positive and significant effects on the remaining outcomes for both genders, with the effect on female students being especially strong: their probability of applying to the centralized admissions system increases by \marar{14.22\%}, the probability of being admitted to at least one program in the system rises by \marar{21.19\%}, and the probability of enrolling in a program within the system increases by \marar{26.04\%}.
...
\marar{Table~\ref{tab: did by vulnerability} shows that the gains in application, admission, and enrollment are concentrated in high-vulnerability schools. For these students, application rates rise by 26.37\%, admission rates by 46.52\%, and enrollment rates by 52.67\% relative to the pre-treatment period. In low-vulnerability schools, by contrast, we find no significant effect on application or enrollment, and only a modest increase in admission (4.93\%). These patterns indicate that the reform expanded access primarily for students in the most socioeconomically disadvantaged schools. We also find a small negative effect on average GPA in high-vulnerability schools. This does not reflect a decline in achievement: grades rose across all schools over this period, and these treated schools raised them less than their comparison group, in a pattern that coincides with the pandemic-era changes to grading.}
...
Table~\ref{tab: did by value added} reports the estimated aggregated treatment effects for each outcome of interest, separately by school value added. \marar{We observe a consistent pattern of positive and statistically significant effects on applications, assignments, and enrollments among students from low--value-added schools, with application rates rising by 25.84\%, admission by 44.61\%, and enrollment by 50.62\%. Among high--value-added schools, by contrast, we find no significant effect on application or enrollment, and only a modest increase in admission (4.85\%).} \marar{As in high-vulnerability schools, we find a small negative effect on high-school GPA among students attending low--value-added schools. As discussed above, this reflects grades rising less than in the comparison group rather than a decline in achievement.}
