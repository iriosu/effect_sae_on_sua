# a20a: DID-V2-UNWEIGHTED-2026-09-01 — version A unweighted
# (w = 1), headline + era, studentized exact RI; derived from a12 —
...
SEED <- 20260831; B_MAIN <- 9999L; N_CORES <- 10L; BITERS <- 10000L
...
stopCluster(cl)
R <- rbindlist(RES)
fwrite(R, file.path(xdir, "output", "versionA_unweighted_results.csv"))
